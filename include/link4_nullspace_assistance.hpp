...
class Link4NullspaceAssistance : public barrett::systems::System {
public:
    ...
    Link4NullspaceAssistance(const link4_sensor::Mounting& mounting,
                            const link4_nullspace::Settings& settings, double period)
        : System("Link4NullspaceAssistance"), ftInput(this), kinInput(this),
          output(this, &outputValue_), mounting_(mounting), controller_(settings, period), fault_(0) {}
    ~Link4NullspaceAssistance() { this->mandatoryCleanUp(); }
...
protected:
    void operate() {
        ...
        link4_nullspace::Jacobian sensorJ, toolJ;
...
private:
    ...
    link4_nullspace::Controller controller_;
